...
var ReactTelephoneInput = function (_React$Component) {
  ...
  ReactTelephoneInput.prototype.formatNumber = function formatNumber(text, pattern, firstCall) {
    ...
    var nextFormatter = new _libphonenumberJs.asYouType();
    ...
    if (this.numberInput.input.value === '+') {
      this.setState({
        ...
        if (typeof _this4.props.onChange === 'function') {
          _this4.props.onChange(_this4.numberInput.input, _this4.state.formattedNumber, _this4.state.selectedCountry, (0, _utils.getUnformattedValue)(_this4.state.formattedNumber));
        }
      });
    }
  };
