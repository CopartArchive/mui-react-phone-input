...
exports.parsePhoneNumber = undefined;
...
var parsePhoneNumber = exports.parsePhoneNumber = function parsePhoneNumber(text) {
  var number = text.replace(/\D/g, '');
  return new _libphonenumberJs.asYouType().input('+' + number);
};
...
var ReactTelephoneInput = function (_React$Component) {
  ...
  ReactTelephoneInput.prototype.formatNumber = function formatNumber(text, pattern) {
    ...
    var finalNumber = new _libphonenumberJs.asYouType().input('+' + text);
    return finalNumber;
  };
